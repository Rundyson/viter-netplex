        ...
        <div className="modal-main bg-primary absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 max-w-[800px] w-full rounded-md border border-line">
            ...
            <div className="modal-banner relative">
                ...
                <div className="absolute bottom-6 left-6 z-40">
                    <h2 className="mb-3">{movieInfo.movie_title}</h2>
                ...
                <button className='absolute top-3 right-3 size-[35px] center-all text-dark bg-light rounded-full' onClick={handleClose}><X/></button>
            </div>
                    ...
                    <div>
                        <ul className="flex gap-3 items-center text-xs mb-3">
                            <li className="border-[1px] border-dark py-1 px-2.5 text-[12px] leading-none">
                                <span className='translate-y-[1px] block'>{movieInfo.movie_rating}</span>
                            </li>
                ...
                <div className="grid grid-cols-3 gap-5">
                    ...
                    {randomize.slice(0,3).map((item, key) => (
                        ...
                        <div className='relative'>
                            <img src={`${imgPath}/${item.movie_image}`} alt="" className='w-full object-cover h-[120px]'/>
                        ...
                        <div className='py-4 bg-secondary'>
                            ...
                            <p className='text-xs text-balance leading-relaxed line-clamp-3'>{item.movie_summary}</p>
                            </div>
                        </div>
                    </div>
                    ))}

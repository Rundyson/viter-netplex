        ...
        <section className="w-full h-[90vh]">
            ...
            <div className="banner text-white">
                ...
                <div className="absolute right-0 bottom-[200px] flex gap-5 items-center">
                    ...
                    <div className="w-[150px] p-4 py-3 bg-[rgba(109,109,110,0.5)] border-l-[4px] border-white text-xl">{getFeatureMovie.movie_rating}</div>
                </div>
            </div>
        </section>
    </>

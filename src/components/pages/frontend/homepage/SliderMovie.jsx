...
const SliderMovie = ({title, filter = ""}) => {
  const sliderRef = React.useRef();
    ...
    const getFilteredMovie = () => movies.filter((item) => item.movie_category === filter);
    ...
    <section className="slider-parent bg-dark -mt-5 relative px-4">
      ...
      <Swiper
        ...
        >
           ...
           {getFilteredMovie().map((item, key) => (
            ...
            <div className="slider-card translate-y-5 group">
              <img src={`${imgPath}/${item.movie_image}`} alt="" 
              ...
              <div className="bg-dark slider-zoom-info p-4 rounded-b-md shadow-lg invisible group-hover:visible opacity-0 group-hover:opacity-100 transition-all ease-linear duration-200">
                ...
                <ul className="flex items-center gap-3 text-xs mt-5">
                  <li className="border-[1px] text-white border-white py-0.5 px-1.5 text-[10px] leading-none">
                    ...
                    <li className="border-[1px] text-white border-white py-0.5 px-1.5 text-[8px] leading-none">
                      HD
                    </li>
                </ul>
              </div>
        ...
        <button
          ...
          className="slider-nav-btn absolute top-[17.8%] z-[1] h-[180px] w-[60px] bg-black bg-opacity-60 opacity-0 transition-opacity hover:opacity-100"
        >
        ...
        <button
          ...
          className="slider-nav-btn absolute top-[17.8%] right-4 z-[1] h-[180px] w-[60px] bg-black bg-opacity-60 opacity-0 transition-opacity hover:opacity-100"
        >
